...
// Default PID gains
#define PID_ROLL_RATE_KP  200.0 //100.0 //250.0
#define PID_ROLL_RATE_KI  150.0 //500.0
#define PID_ROLL_RATE_KD  0.5 //2.5
#define PID_ROLL_RATE_KFF 0.0
#define PID_ROLL_RATE_INTEGRATION_LIMIT    30.0 //33.3

#define PID_PITCH_RATE_KP  200.0 //100.0 //250.0
#define PID_PITCH_RATE_KI  150.0 //500.0
#define PID_PITCH_RATE_KD  0.5 //2.5
#define PID_PITCH_RATE_KFF 0.0
#define PID_PITCH_RATE_INTEGRATION_LIMIT   30 //33.3

#define PID_YAW_RATE_KP  80.0 //120.0
#define PID_YAW_RATE_KI  1.0 //16.7
#define PID_YAW_RATE_KD  0.0
#define PID_YAW_RATE_KFF 0.0
#define PID_YAW_RATE_INTEGRATION_LIMIT     40.0 //166.7

#define PID_ROLL_KP  3.0 //6.0
#define PID_ROLL_KI  1.0 //3.0
#define PID_ROLL_KD  0.0
#define PID_ROLL_KFF 0.0
#define PID_ROLL_INTEGRATION_LIMIT    20.0

#define PID_PITCH_KP  3.0 //6.0
#define PID_PITCH_KI  1.0 //3.0
...
#define PID_VEL_X_KP 0.0 //25.0f
#define PID_VEL_X_KI 0.0 //1.0f
#define PID_VEL_X_KD 0.0f
#define PID_VEL_X_KFF 0.0f

#define PID_VEL_Y_KP 0.0 //25.0f
#define PID_VEL_Y_KI 0.0 //1.0f
#define PID_VEL_Y_KD 0.0f
#define PID_VEL_Y_KFF 0.0f

#define PID_VEL_Z_KP 0.0 //25.0f
#define PID_VEL_Z_KI 0.0 //15.0f
